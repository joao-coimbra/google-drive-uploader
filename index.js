...
const spacesCalc = (spacesDefault=Int8Array, spacesOcuped=String) => Array(spacesDefault - spacesOcuped.toString().length).fill(' ').join('')

console.log(`┌─────┬────────────────────┬─────────────────┬────────┐`)
console.log(`│ id  │ login              │ type            │ admin  │`)
console.log(`├─────┼────────────────────┼─────────────────┼────────┤`)

list.forEach((item, index) => {
    console.log('│',
    `${spacesCalc(3, index)}${clc.redBright.bold(index)}`,
    '│',
    `${item.login}${spacesCalc(18, item.login)}`,
    '│',
    `${clc.cyan(item.type)}${spacesCalc(15, item.type)}`,
    '│',
    `${clc.yellow(item.site_admin)}${spacesCalc(6, item.site_admin)}`,
    '│'
    )
